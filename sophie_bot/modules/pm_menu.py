...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(InlineKeyboardButton(strings['btn_chat'], url='https://t.me/NaoSupport'),
...
async def help_cb(event, strings):
    ...
    button.add(InlineKeyboardButton(strings['click_btn'], url='https://github.com/WeebTime/NaoTomoriRobot/wiki'))
...
async def help_cmd(message, strings):
    button = InlineKeyboardMarkup().add(InlineKeyboardButton(
        strings['click_btn'], url='https://github.com/WeebTime/NaoTomoriRobot/wiki'
    ))
